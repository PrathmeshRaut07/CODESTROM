...
// Define types for your extensions
interface Trace {
    type: string;
    payload: {
        name?: string;
...
export const FormExtension = {
    ...
    render: ({ trace, element }: RenderProps) => {
...
export const DateExtension = {
    ...
    render: ({ trace, element }: RenderProps) => {
        ...
        const submitButton = formContainer.querySelector('#submit') as HTMLInputElement;
        const dateInput = formContainer.querySelector('#date') as HTMLSelectElement;
        const hoursInput = formContainer.querySelector('#hours') as HTMLInputElement;
        const minutesInput = formContainer.querySelector('#minutes') as HTMLInputElement;
